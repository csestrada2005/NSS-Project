...
### Community 41 - "dispatchEventWithEnableCapturePhaseSelectiveHydrationWithoutDiscreteEventReplay"
Cohesion: 0.06
...
### Community 42 - "InspectorPanel.tsx"
Cohesion: 0.38
...
### Community 64 - "ref_node_assert_strict"
Cohesion: 0.11
...
### Community 91 - "projectMemoryMigrationPaths.test.js"
Cohesion: 0.08
...
### Community 98 - "getComponentNameFromType"
Cohesion: 0.18
...
### Community 107 - "edgeFunctionPath.test.js"
Cohesion: 0.73
...
### Community 117 - "warnIfNotHydrating"
Cohesion: 0.38
...
- **Why does `react` connect `react` to `package.json`, `button.tsx`, `tabs.tsx`, `StudioEngine.tsx`, `SettingsModal.tsx`, `PreviewOverlay.tsx`, `InspectorPanel.tsx`, `lucide-react`, `SupabaseService`, `PropertyPanel.tsx`, `DealsPage.tsx`, `sonner`, `Forecast.tsx`, `AuthContext.tsx`, `Performance.tsx`, `MetricsPage.tsx`, `ref_contexts_languagecontext`, `ChatInterface.tsx`, `FileExplorer.tsx`, `BrowserCompiler.ts`, `table.tsx`, `StateGraph.tsx`, `ProjectHubPage.tsx`?**
