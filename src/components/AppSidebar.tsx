...
const navItems: NavItem[] = [
  ...
  { id: "metricas", label: { es: "Metricas", en: "Metrics" }, icon: BarChart3 },
          ...
          {!collapsed ? (
            <>
              <div className="flex items-center gap-3 px-1">
                <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-semibold bg-primary/10 text-primary">U</div>
            ...
            <button
              ...
              title={lang === "es" ? "Cerrar sesion" : "Log out"}
            >
              <LogOut size={16} />
            </button>
          )}
